<template>
	<view class="pb-130">
		...
		<view class="m-30 box-shadow border-radius-20 p-30 d-flex-between-center animated fadeInUp position-relative overflow-hidden" v-for="(item,index) in list" :key="index" @click="$utils.jump('/pages/nft/artistDetail?uid='+item.id)">
