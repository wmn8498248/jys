			...
			<view class="px-30 market">
				...
				<scroll-view scroll-y="true">
					<view class="market-item" v-for="item in quotation.filter(it=>active==1?it.market_from==1:it.market_from!=1)"
						@click="jump(item.currency_name,item.legal_name,item.currency_id)" :key="item.currency_id">
						<view class="left">
							<text class="d-block">
			...
			<view class="px-30">
				...
				<view class="d-flex overflow-hidden">
					<view class="text-white w-50">
						...
						<view class="d-flex-between-center px-10 py-16 position-relative font-size-22" v-for="(item,index) in buyList" :key="index">
					...
					<view class="text-white w-50">
						...
						<view class="d-flex-between-center px-10 py-16 position-relative font-size-22" v-for="(item,index) in sellList" :key="index">
				...
				<view class="bg_ditu" style="padding: 16px 16px 0px 16px;">
					...
					<view class="py-16">
						...
						<view class="d-flex-between-center mt-16" v-if="buyDirection == 1">
							<view v-for="(item,index) in timers.slice(0, 3)" :key="index" class="tag text-center font-size-30 d-block" :class="currentTimer == item.seconds ? 'tag-success py-12' : 'border_4D5563 py-10'" @click="currentTimer=item.seconds,currentRatio=item.profit_ratio,currentTimerObj=item" style="width: 30%;border-radius: 6rpx;">
						...
						<view class="d-flex-between-center mt-16" v-if="buyDirection == 1">
							<view v-for="(item,index) in timers.slice(3, 6)" :key="index" class="tag text-center font-size-30 d-block" :class="currentTimer == item.seconds ? 'tag-success py-12' : 'border_4D5563 py-10'" @click="currentTimer=item.seconds,currentRatio=item.profit_ratio,currentTimerObj=item" style="width: 30%;border-radius: 6rpx;">
								<view class="d-flex" style="justify-content: center; align-items: center; padding: 10rpx;">
									<span>{{item.seconds}}s</span>
									<span :class="currentTimer == item.seconds ? '' :'opacity-50'" style="display: flex; height: 100%; width: 1px; color: black; margin: 0 10rpx; justify-content: center;">|</span>
									<span :class="currentTimer == item.seconds ? '' :'opacity-50'" style="display: block; color: black;">{{item.profit_ratio}}%</span>
						...
						<view class="d-flex-between-center mt-16" v-else-if="buyDirection == 2">
							<view v-for="(item,index) in timers.slice(0, 3)" :key="index"  class="tag text-center font-size-30 d-block" :class="currentTimer == item.seconds ? 'tag-error py-12' : 'border_4D5563 py-10'" @click="currentTimer=item.seconds,currentRatio=item.profit_ratio,currentTimerObj=item" style="width: 30%;border-radius: 6rpx;">
								<view class="d-flex" style="justify-content: center; align-items: center; padding: 10rpx;">
									<span>{{item.seconds}}s</span>
									<span :class="currentTimer == item.seconds ? '' :'opacity-50'" style="display: flex; height: 100%; width: 1px; color: black; margin: 0 10rpx; justify-content: center;">|</span>
									<span :class="currentTimer == item.seconds ? '' :'opacity-50'" style="display: block; color: black;">{{item.profit_ratio}}%</span>
						...
						<view class="d-flex-between-center mt-16" v-if="buyDirection == 2">
							<view v-for="(item, index) in timers.slice(3, 6)" :key="index" class="tag text-center font-size-30 d-block" :class="currentTimer == item.seconds ? 'tag-error py-12' : 'border_4D5563 py-10'" @click="currentTimer=item.seconds,currentRatio=item.profit_ratio,currentTimerObj=item" style="width: 30%;border-radius: 6rpx;">
								<view class="d-flex" style="justify-content: center; align-items: center; padding: 10rpx;">
									<span>{{item.seconds}}s</span>
									<span :class="currentTimer == item.seconds ? '' :'opacity-50'" style="display: flex; height: 100%; width: 1px; color: black; margin: 0 10rpx; justify-content: center;">|</span>
									<span :class="currentTimer == item.seconds ? '' :'opacity-50'" style="display: block; color: black;">{{item.profit_ratio}}%</span>
