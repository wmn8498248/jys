	...
	<view class="pb-60 text-white">
		...
		<view class="mx-30 mt-30">
			...
			<view class="product">
				...
				<view class="d-grid text-center py-20 align-items-center" style="grid-template-columns:1.2fr .5fr 1fr 1fr 1.2fr;grid-column-gap:10rpx" v-for="(item, index) in historyOrder" :key="index">
