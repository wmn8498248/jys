		...
		<view class="px-30">
			<view class="py-30 ">
				...
				<view class="d-flex mt-20">
					<u-button class="mx-0 mr-16 px-40"  :type="activeCopyType == item.id ? 'primary' : 'black'" v-for="(item, index) in copyType" :key="index" size="medium" @click="activeCopyType = item.id">{{item.name}}</u-button>
				</view>
