<template>
	<view class="text-white">
		<u-navbar backIconColor="black" :borderBottom='false' :isFixed="false" :background="{background:'rgb(242, 246, 247)'}" title-color="black" :title="i18n.applySubscription"></u-navbar>
		<view class="m-30">
			<view class="p-30 box-shadow border-radius-20 bg-white">
				<text class="d-block font-size-32 pb-20">{{project.title}}</text>
			...
			<view class="p-30 box-shadow border-radius-20 mt-40  bg-white">
				<text class="d-block font-size-32 pb-20 ">{{i18n.subscriptionCycle}}</text>
				<view class="d-flex-between-center mt-20">
			...
			<view class="p-30 box-shadow border-radius-20 mt-40  bg-white">
				<text class="d-block font-size-32 pb-20 ">{{i18n.projectDetails}}</text>
				<view class="mt-20">
