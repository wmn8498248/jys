<template>
	<view class="mx-30 pb-200">
		...
		<view class="mx-30 mt-50 animated fadeInUp">
			...
			<view class="mt-24  border-radius-10 d-flex-between-center p-30" v-for="(item, index) in order.slice(0,3)" :key="index" style="background-image: linear-gradient(225deg, #edf1f9 0%, #e4efe9 100%);">
				<view class="d-flex align-items-center">
