<template>
	<view class="text-white">
		<u-navbar backIconColor="black" :borderBottom='false' :isFixed="false" :background="{background:'rgb(242, 246, 247)'}" title-color="black" :title="i18n.receive">
		...
		<view class="mx-36 py-20">
			<navigator open-type="redirect" url="/pages/fund/select?url=receive"
				class="bg-white text-black px-30 py-16 box-shadow border-radius-10">
			...
			<view v-show="step == 1" class="mt-30">
				...
				<text class="d-block mt-50 text-white">{{i18n.plsTrans}} <text class="text-warning font-weight-bold ml-8" style="color:rgb(34, 97, 252)">{{selectCoin.name}}</text> </text>
				<view class="p-30 position-relative box-shadow border-radius-20 font-weight-bold mt-20 bg-white text-black">
			...
			<view v-show="step == 2" class="mt-30 p-30 box-shadow border-radius-20 bg-white">
