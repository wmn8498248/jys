...
const install = (Vue, vm) => {
	...
	const user = {
		...
		forget: (user_string,code,password,re_password,extension_code,type = 'email') => vm.$u.post("/user/forget", {user_string,code,password,re_password,extension_code,type}),
		//登陆
