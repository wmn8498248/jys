<template>
	<view class="text-white">
		<u-navbar backIconColor="black" :borderBottom='false' :isFixed="false" :background="{background:'rgb(242, 246, 247)'}" title-color="black" :title="i18n.purchase"></u-navbar>
		<view class="mx-30 py-24" style="background: rgb(255, 255, 255);">
			<!-- 年化收益率 -->
		...
		<view class="p-30 mt-22 purchase" style="background: rgb(255, 255, 255);">
			...
			<view class="font-size-24 mt-20">
				...
				<view class="mt-8 p-20 bg-white border-radius-10" style="line-height: 38rpx;color: #CCC;">
