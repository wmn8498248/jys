	...
	<view class="" style="color: #fff;">
				...
				<view class="pr-20 position-relative opacity-90" style="height: 780rpx;">
					...
					<view class="mt-20">
						...
						<view class="d-flex mt-16" v-if="buyDirection==0">
							<view class="" v-for="(item, idnex) in muit" :key="index">
		...
		<view class="">
			...
			<block v-if="positionList.length">
				<view class="d-grid py-20 text-center align-items-center border-bottom" style="grid-template-columns:1fr 1fr 1.4fr .7fr 1.2fr;" v-for="(item, index) in positionList" :key="index">
