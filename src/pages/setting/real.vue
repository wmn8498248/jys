<template>
	<view class="text-white">
		<u-navbar backIconColor="black" :borderBottom='false' :isFixed="false" :background="{background:'rgb(242, 246, 247)'}" title-color="black" :title="i18n.authentication"></u-navbar>
		<!-- 初级认证 -->
		<view class="p-30 m-30 box-shadow bg-white border-radius-20" v-if="type == 1">
			<!-- 未认证 -->
