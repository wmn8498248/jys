		...
		<u-popup v-model="showSelectCoin" mode="top" length="780" contentBackgroundColor="#333333"
			...
			<view class="px-30 market">
				...
				<scroll-view scroll-y="true" style="height: 600rpx;">
					<view class="market-item" v-for="item in quotation" :key="item.currency_id"
				...
				<view class="p-30">
					...
					<view class="u-border-bottom py-16">
						...
						<view class="d-flex-between-center mt-16" v-if="buyDirection == 1">
							<text v-for="(item, index) in timers" :key="index" class="tag py-10  w-19 text-center font-size-30 d-block" :class="currentTimer == item ? 'tag-success' : 'tag-plain-success'" @click="currentTimer=item">{{item}}s</text>
						</view>
						<view class="d-flex-between-center mt-16" v-else-if="buyDirection == 2">
							<text v-for="(item, index) in timers" :key="index" class="tag py-10  w-19 text-center font-size-30 d-block" :class="currentTimer == item ? 'tag-error' : 'tag-plain-error'" @click="currentTimer=item">{{item}}s</text>
						</view>
					</view>
					<view class="py-16">
